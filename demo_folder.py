...
if __name__ == "__main__":
    ...
    for split, dataset in zip(splits, datasets):
        ...
        for i, data in enumerate(tqdm.tqdm(loader)):
            ...
            # print(names[0])
            dir1 = '/home/user/wwj/Ultra-Fast-Lane-Detection-master/my_test/byCulane/image_mapillary_pred/' + names[0]
            dir2 = dir1.split('/' + dir1.split('/')[-1], 1)[0]
